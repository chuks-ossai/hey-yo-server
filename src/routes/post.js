...
router.put('/like', AsyncErrorHandler(PostController.like));
router.put('/unlike', AsyncErrorHandler(PostController.unlike));
router.put('/comment', AsyncErrorHandler(PostController.comment));
